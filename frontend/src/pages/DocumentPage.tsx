...
export function DocumentPage() {
  ...
  const handleAsk = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Unable to ask the document.",
      );
    } finally {
  ...
  const progressText = flashcards.length
  ...
  return (
    <div className="document-page">
      ...
      <div
        className="tab-row document-tabs"
        role="tablist"
            ...
            <div className="flashcard-stack">
              ...
              <div className="flashcard-controls">
                <button
                  ...
                  onClick={() => {
                    setFlashcardIndex((value) =>
                      value === 0 ? flashcards.length - 1 : value - 1,
                    );
                    setShowAnswer(false);
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    setFlashcardIndex(
                      (value) => (value + 1) % flashcards.length,
                    );
                    setShowAnswer(false);
                  }}
                  disabled={flashcards.length <= 1}
        ...
        <div className="panel">
          ...
          {quizResult ? (
            ...
            <div className="loading-box">
              StudyPilot is creating your quiz...
            </div>
          ) : quiz.length === 0 ? (
            <div className="empty-box">
              <p>No quiz yet.</p>
